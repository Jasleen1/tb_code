...
rhs = @(t,u) ...
    [(1 - u(1) - u(2) - p1)*(u(1) + p1 + i2*u(3)) - u(1)*(u(2) + i2*u(4)) ; ...
    (1 - u(1) - u(2) - p1)*(u(2)+i2*u(4)) - u(2)*(u(1) + p1 + i2*u(3)) ; ...
    (1 - u(3) - u(4) - p2)*(u(3) + p2 + i1*u(1)) - u(3)*(u(4) + i1*u(1)) ; ...
    (1 - u(3) - u(4) - p2)*(u(4)+i1*u(2)) - u(4)*(u(3) + p2 + i1*u(1))];
